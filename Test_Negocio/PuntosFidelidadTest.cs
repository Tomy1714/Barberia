...
{
    [TestClass]
    public class PuntosFidelidadTest
    {
        private PuntosFidelidadNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<PuntosFidelidad>));
        }
        ...
        {
            // Arrange
            var entidad = new PuntosFidelidad
            {
                IdCliente = 1, PuntosAcumulados = 0, FactorConversion = 100
            };
            ...
            Assert.AreNotEqual(0, resultado.IdPuntos);
        }
