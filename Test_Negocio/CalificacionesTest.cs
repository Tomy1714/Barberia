...
namespace MSTestBarberia
{
    ...
    {
        private CalificacionesNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Calificaciones>));
        }
        ...
        {
            // Arrange
            var entidad = new Calificaciones
            {
                IdCita = 1, IdBarbero = 1, Puntaje = 5, Comentario = "Excelente"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdCalificacion);
        }
