...
namespace MSTestBarberia
{
    ...
    {
        private PersonasNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Personas>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                Identificacion = "111222333", Nombres = "Juan", Apellidos = "Perez", Telefono = "3001234567", Correo = "juan@mail.com"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdPersona);
        }
