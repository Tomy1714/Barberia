...
{
    [TestClass]
    public class BarberosTest
    {
        private BarberosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Barberos>));
        }
        ...
        {
            // Arrange
            var entidad = new Barberos
            {
                IdEmpleado = 1, Especialidad = "Degradados", PorcentajeComision = 15, ServiciosMes = 0, ValorPromServicio = 30000, Activo = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdBarbero);
        }
