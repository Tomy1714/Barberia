...
namespace MSTestBarberia
{
    ...
    {
        private PagosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Pagos>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdCita = 1, Monto = 30000, Descuento = 0, Total = 30000, NombreMetodo = "Tarjeta", EstadoPago = "Pendiente"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdPago);
        }
