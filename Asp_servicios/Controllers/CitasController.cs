...
namespace Asp_Servicios.Controllers
{
    ...
    public class CitasController : ControllerBase
    {
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdCita == id);
                if (entidad == null)
        ...
        // POST: api/Citas
        [HttpPost]
        public IActionResult Guardar([FromBody] Citas? entidad)
        {
            try
            {
        ...
        // PUT: api/Citas
        [HttpPut]
        public IActionResult Modificar([FromBody] Citas? entidad)
        {
            try
            {
        ...
        // DELETE: api/Citas
        [HttpDelete]
        public IActionResult Borrar([FromBody] Citas? entidad)
        {
            try
            {
