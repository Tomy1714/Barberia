...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private readonly PersonasNegocio negocio;

        public PersonasController()
        {
            Conexion conexion = new Conexion();
            conexion.StringConexion = Configuraciones.obtener("StringConexion");
            negocio = new PersonasNegocio(conexion);
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdPersona == id);
                if (entidad == null)
        ...
        // POST: api/Personas
        [HttpPost]
        public IActionResult Guardar([FromBody] Personas? entidad)
        {
            try
            {
        ...
        // PUT: api/Personas
        [HttpPut]
        public IActionResult Modificar([FromBody] Personas? entidad)
        {
            try
            {
        ...
        // DELETE: api/Personas
        [HttpDelete]
        public IActionResult Borrar([FromBody] Personas? entidad)
        {
            try
            {
