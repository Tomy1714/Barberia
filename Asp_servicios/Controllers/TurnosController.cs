...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private readonly TurnosNegocio negocio;

        public TurnosController()
        {
            Conexion conexion = new Conexion();
            conexion.StringConexion = Configuraciones.obtener("StringConexion");
            negocio = new TurnosNegocio(conexion);
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdTurno == id);
                if (entidad == null)
        ...
        // POST: api/Turnos
        [HttpPost]
        public IActionResult Guardar([FromBody] Turnos? entidad)
        {
            try
            {
        ...
        // PUT: api/Turnos
        [HttpPut]
        public IActionResult Modificar([FromBody] Turnos? entidad)
        {
            try
            {
        ...
        // DELETE: api/Turnos
        [HttpDelete]
        public IActionResult Borrar([FromBody] Turnos? entidad)
        {
            try
            {
