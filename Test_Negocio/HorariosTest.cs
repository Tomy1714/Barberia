...
namespace MSTestBarberia
{
    ...
    {
        private HorariosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Horarios>));
        }
        ...
        {
            // Arrange
            var entidad = new Horarios
            {
                IdEmpleado = 1, HoraEntrada = 8, HoraSalida = 17, Activo = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdHorario);
        }
