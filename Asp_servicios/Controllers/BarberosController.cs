...
namespace Asp_Servicios.Controllers
{
    ...
    public class BarberosController : ControllerBase
    {
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdBarbero == id);
                if (entidad == null)
        ...
        // POST: api/Barberos
        [HttpPost]
        public IActionResult Guardar([FromBody] Barberos? entidad)
        {
            try
            {
        ...
        // PUT: api/Barberos
        [HttpPut]
        public IActionResult Modificar([FromBody] Barberos? entidad)
        {
            try
            {
        ...
        // DELETE: api/Barberos
        [HttpDelete]
        public IActionResult Borrar([FromBody] Barberos? entidad)
        {
            try
            {
