...
namespace MSTestBarberia
{
    ...
    {
        private CombosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Combos>));
        }
        ...
        {
            // Arrange
            var entidad = new Combos
            {
                IdServicio = 1, DescuentoCombo = 10, Descripcion = "Paquete completo"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdCombo);
        }
