...
namespace MSTestBarberia
{
    ...
    {
        private CitasNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Citas>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdCliente = 1, IdBarbero = 1, IdServicio = 1, FechaHoraInicio = DateTime.Now, Estado = "Pendiente"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdCita);
        }
