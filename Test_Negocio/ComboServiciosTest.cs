...
{
    [TestClass]
    public class ComboServiciosTest
    {
        private ComboServiciosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<ComboServicios>));
        }
        ...
        {
            // Arrange
            var entidad = new ComboServicios
            {
                IdCombo = 1, IdServicio = 1
            };
            ...
            Assert.AreNotEqual(0, resultado.IdComboServicio);
        }
