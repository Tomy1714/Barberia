...
namespace Asp_Servicios.Controllers
{
    ...
    public class PagosController : ControllerBase
    {
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdPago == id);
                if (entidad == null)
        ...
        // POST: api/Pagos
        [HttpPost]
        public IActionResult Guardar([FromBody] Pagos? entidad)
        {
            try
            {
        ...
        // PUT: api/Pagos
        [HttpPut]
        public IActionResult Modificar([FromBody] Pagos? entidad)
        {
            try
            {
        ...
        // DELETE: api/Pagos
        [HttpDelete]
        public IActionResult Borrar([FromBody] Pagos? entidad)
        {
            try
            {
