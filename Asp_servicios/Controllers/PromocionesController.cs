...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private readonly PromocionesNegocio negocio;
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdPromocion == id);
                if (entidad == null)
        ...
        [HttpPost]
        public IActionResult Guardar([FromBody] Promociones? entidad)
        {
            try
            {
        ...
        // PUT: api/Promociones
        [HttpPut]
        public IActionResult Modificar([FromBody] Promociones? entidad)
        {
            try
            {
        ...
        // DELETE: api/Promociones
        [HttpDelete]
        public IActionResult Borrar([FromBody] Promociones? entidad)
        {
            try
            {
