...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private readonly FacturasNegocio negocio;
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdFactura == id);
                if (entidad == null)
        ...
        // POST: api/Facturas
        [HttpPost]
        public IActionResult Guardar([FromBody] Facturas? entidad)
        {
            try
            {
        ...
        // PUT: api/Facturas
        [HttpPut]
        public IActionResult Modificar([FromBody] Facturas? entidad)
        {
            try
            {
        ...
        // DELETE: api/Facturas
        [HttpDelete]
        public IActionResult Borrar([FromBody] Facturas? entidad)
        {
            try
            {
