...
{
    [TestClass]
    public class HorariosDiasTest
    {
        private HorariosDiasNegocio negocio = null!;
        ...
        public void Inicializar()
        {
            ...
            negocio = new HorariosDiasNegocio(conexion);
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<HorariosDias>));
        }
        ...
        {
            // Arrange
            var entidad = new HorariosDias
            {
                IdHorario = 1, Dia = "Lunes"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdHorarioDia);
        }
