...
namespace MSTestBarberia
{
    ...
    {
        private ProductosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Productos>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                Nombre = "Gel Fijador", Marca = "Taft", Categoria = "Fijacion", PrecioCompra = 8000, PrecioVenta = 15000, StockActual = 20, Activo = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdProducto);
        }
