...
namespace MSTestBarberia
{
    ...
    {
        private InventarioProductosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<InventarioProductos>));
        }
        ...
        {
            // Arrange
            var entidad = new InventarioProductos
            {
                IdInventario = 1, IdProducto = 1, Cantidad = 10
            };
            ...
            Assert.AreNotEqual(0, resultado.IdInventarioProducto);
        }
