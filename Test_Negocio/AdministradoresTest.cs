...
namespace MSTestBarberia
{
    ...
    {
        private AdministradoresNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Administradores>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdEmpleado = 1, NombreNegocio = "BarberPro", PorcentajeUtilidades = 30, UtilidadesUltimoMes = 5000000
            };
            ...
            Assert.AreNotEqual(0, resultado.IdAdministrador);
        }
        ...
        public void Modificar_Entidad_Valida()
        {
            ...
            NombreNegocio = "Barberia Central";
