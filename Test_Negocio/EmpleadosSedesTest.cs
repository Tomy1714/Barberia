...
{
    [TestClass]
    public class EmpleadosSedesTest
    {
        private EmpleadosSedesNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<EmpleadosSedes>));
        }
        ...
        {
            // Arrange
            var entidad = new EmpleadosSedes
            {
                IdEmpleado = 1, IdSede = 1, FechaAsignacion = DateTime.Now
            };
            ...
            Assert.AreNotEqual(0, resultado.IdEmpleadoSede);
        }
