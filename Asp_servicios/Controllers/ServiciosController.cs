...
namespace Asp_Servicios.Controllers
{
    ...
    {
        private readonly ServiciosNegocio negocio;
        ...
        public IActionResult ObtenerPorId(int id)
        {
            ...
            {
                var lista  = negocio.Listar();
                var entidad = lista.FirstOrDefault(e => e.IdServicio == id);
                if (entidad == null)
        ...
        // POST: api/Servicios
        [HttpPost]
        public IActionResult Guardar([FromBody] Servicios? entidad)
        {
            try
            {
        ...
        // PUT: api/Servicios
        [HttpPut]
        public IActionResult Modificar([FromBody] Servicios? entidad)
        {
            try
            {
        ...
        [HttpDelete]
        public IActionResult Borrar([FromBody] Servicios? entidad)
        {
            try
            {
