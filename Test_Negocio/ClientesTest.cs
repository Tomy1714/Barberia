...
namespace MSTestBarberia
{
    ...
    {
        private ClientesNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Clientes>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdPersona = 1, TotalVisitas = 0, Activo = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdCliente);
        }
