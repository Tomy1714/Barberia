...
namespace MSTestBarberia
{
    ...
    {
        private TurnosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Turnos>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdBarbero = 1, IdSede = 1, FechaTurno = DateTime.Now, HoraInicio = 8, HoraFin = 17, Estado = "Programado"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdTurno);
        }
