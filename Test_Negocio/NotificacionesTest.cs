...
namespace MSTestBarberia
{
    ...
    {
        private NotificacionesNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Notificaciones>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdCliente = 1, IdCita = 1, Tipo = "Confirmacion", Canal = "Correo", Mensaje = "Tu cita fue confirmada", Estado = "Pendiente"
            };
            ...
            Assert.AreNotEqual(0, resultado.IdNotificacion);
        }
