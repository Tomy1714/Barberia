...
namespace MSTestBarberia
{
    ...
    {
        private SedesNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Sedes>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                Nombre = "Sede Norte", Direccion = "Calle 10", Ciudad = "Medellin", Telefono = "3001234567", Correo = "norte@barberia.com", CapacidadMaxima = 5, Activa = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdSede);
        }
