...
namespace MSTestBarberia
{
    ...
    {
        private EmpleadosNegocio negocio = null!;
        ...
        public void Listar_Retorna_Lista()
        {
            ...
            Assert.IsInstanceOfType(lista, typeof(List<Empleados>));
        }
        ...
        public void Guardar_Entidad_Valida()
        {
            ...
            {
                IdPersona = 1, Cargo = "Barbero", SalarioBase = 1200000, Activo = true
            };
            ...
            Assert.AreNotEqual(0, resultado.IdEmpleado);
        }
